...
class MainActivity : AppCompatActivity(), ContextProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        save.setOnClickListener {
            val user = User(name.text.toString(), surname.text.toString(), age.text.toString().toInt())
            userPref = user

            Toast.makeText(this, "User saved. Restart the app to reload from preferences.", Toast.LENGTH_SHORT).show()
        }
    }
